...
namespace DatabaseFirstApproach
{
    ...
    public partial class AdventureWorks : DbContext
    {
        ...
        [DbFunction("AdventureWorks", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[AdventureWorks].[ufnGetAllCategories]()");
        }
    
        [DbFunction("AdventureWorks", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[AdventureWorks].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
